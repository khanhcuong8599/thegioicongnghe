...
class CategoryProduct extends Controller
{
    ...
    public function unactive_category_product(Request $request, $category_product_id){
        ...
        $request->session()->flash('statuscode', 'success');
        return Redirect::to('all-category-product')->with('status','Hiển thị danh mục sản phẩm thành công!!!');
    }
    public function active_category_product(Request $request, $category_product_id){
        ...
        $request->session()->flash('statuscode', 'success');
        return Redirect::to('all-category-product')->with('status','Ẩn danh mục sản phẩm thành công!!!');
    }
