    ...
    <div class="recommended_items"><!--recommended_items-->
        ...
        <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                                ...
                                <div class="single-products">
                                    <a href="{{URL::to('chi-tiet-san-pham/'.$lienquan->product_id)}}">
                                        <div class="productinfo text-center">
                                            ...
                                            <p style="overflow: hidden;  display: -webkit-box;  -webkit-line-clamp: 2;  -webkit-box-orient: vertical;">{{$lienquan->product_name}}</p>
                ...
                <div class="item">
                    @foreach($relate_brand as $key => $cungthuonghieu)
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <a href="{{URL::to('chi-tiet-san-pham/'.$cungthuonghieu->product_id)}}">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to('/public/upload/product/'.$cungthuonghieu->product_image)}}" alt=""/>
                                            <p style="overflow: hidden;  display: -webkit-box;  -webkit-line-clamp: 2;  -webkit-box-orient: vertical;">{{$cungthuonghieu->product_name}}</p>
                                            <h2 style="font-size: 20px">{{number_format($cungthuonghieu->product_price).' VNĐ'}}</h2>
                                            <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
                                        </div>
                                    </a>
                                </div>
