                    ...
                    @foreach($all_brand_product as $key => $brand_pro)
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <a onclick="return confirm('Bạn có chắc bạn muốn xóa thương hiệu này không??')" href="{{URL::to('/delete-brand-product'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
