        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    if($message){
                        echo '<span class="text-alert" style="text-align: center; color: red; width: 100%; font-size: 15px; font-weight: bold">'.$message.'</span>';
                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="product_code" class="form-control" id="exampleInputEmail1" value="{{$pro->product_code}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="product_image" class="form-control" id="exampleInputEmail1" value="{{$pro->product_image}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_cate" class="form-control input m-bot15">
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_brand" class="form-control input m-bot15">
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_status" class="form-control input m-bot15">
