                    ...
                    @foreach($all_product as $key => $pro)
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <a onclick="return confirm('Bạn có chắc bạn muốn xóa sản phẩm này không??')" href="{{URL::to('/delete-product'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
