            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                        ...
                        <th>Trạng thái</th>
                        <th style="width:60px">Tùy chọn</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($all_category_product as $key => $cate_pro)
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <a onclick="return confirm('Bạn có chắc bạn muốn xóa danh mục này không??')" href="{{URL::to('/delete-category-product'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
